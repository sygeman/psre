...
import { home, globeAlt, trophy, userCircle, clipboardDocumentList, userGroup } from 'solid-heroicons/outline';
...
export const BottomMenu = () => {
  ...
  return (
    <div class="grid h-16 w-full grid-cols-5 bg-slate-800">
      <A
        href={isHome() ? '/region' : '/'}
